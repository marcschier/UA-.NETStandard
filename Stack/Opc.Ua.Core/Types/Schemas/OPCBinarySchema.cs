...
namespace Opc.Ua.Schema.Binary
{
    ...
    public partial class TypeDescription
    {
        ...
        {
            get => defaultByteOrderField;
            set => defaultByteOrderField = value;
        }
        ...
        {
            get => defaultByteOrderFieldSpecified;
            set => defaultByteOrderFieldSpecified = value;
        }
    }
