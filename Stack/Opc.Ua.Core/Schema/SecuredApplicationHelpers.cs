...
namespace Opc.Ua.Security
{
    ...
    public partial class SecuredApplication
    {
        ...
        {
            get => TrustedCertificateStore;
            set => TrustedCertificateStore = value;
        }
        ...
        {
            get => IssuerCertificateStore;
            set => IssuerCertificateStore = value;
        }
